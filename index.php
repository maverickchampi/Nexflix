...
<body>
  ...
  <main class="main">
    <div class="list">
      ...
      <button role="button" id="flecha-derecha" class="flecha-derecha r-one"><i class="fas fa-angle-right"></i></button>
    </div>
    <div class="list">
      ...
      <button role="button" id="flecha-derecha" class="flecha-derecha r-two"><i class="fas fa-angle-right"></i></button>
    </div>
    <div class="list">
      ...
      <button role="button" id="flecha-derecha" class="flecha-derecha r-three"><i class="fas fa-angle-right"></i></button>
    </div>
  </main>
