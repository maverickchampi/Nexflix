...
<body>
    ...
    <?php $nex = $nexflix[22]; ?> <!-- Unica linea a cambiar -->
    <main>
    ...
    <section class="section">
        <div class="list">
            ...
            <button role="button" onclick="moverDerecha('exclusivas')" class="flecha-derecha r-four"><i class="fas fa-angle-right"></i></button>
        </div>
    </section>
